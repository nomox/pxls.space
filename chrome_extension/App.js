...
window.App = {
    ...
    initBoardPlacement: function() {
        ...
        this.elements.board.on("pointerdown mousedown", function(b) {
            ...
            var g = Math.abs(c - f);
            5 > Math.abs(a - e) && 5 > g && -1 !== this.color && this.cooldown < (new Date).getTime() && (0 === b.button || d) && (b = this.screenToBoardSpace(e, f),
    ...
    initSocket: function() {
        ...
        c.onmessage = function(a) {
            ...
            .bind(this)) : "alert" === a.type ? this.alert(a.message) : "cooldown" === a.type ? (this.cooldown = (new Date).getTime() + 1E3 * a.wait,
            this.updateTime(0),
